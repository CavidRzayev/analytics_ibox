...
!function($) {
  "use strict";
      ...
      var switchery = new Switchery(primary, { color: '#3E8B69' });
      ...
      var switchery = new Switchery(primary_small, { color: '#3E8B69', size: 'small' });
      ...
      var switchery = new Switchery(primary_large, { color: '#3E8B69', size: 'large' });
      ...
      var switchery = new Switchery(primary_multicolor, { color: '#3E8B69', jackColor: '#dbe5fd' });
      ...
      var switchery = new Switchery(primary_multicolor_on_off, { color: '#3E8B69', secondaryColor: '#949ca9', jackColor: '#dbe5fd', jackSecondaryColor: '#e9eaed' });
      var secondary_multicolor_on_off = document.querySelector('.js-switch-secondary-multicolor-on-off');
      var switchery = new Switchery(secondary_multicolor_on_off, { color: '#96a3b6', secondaryColor: '#3E8B69', jackColor: '#e9eaed', jackSecondaryColor: '#dbe5fd' });
